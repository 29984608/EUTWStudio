...
public class CourseModuleController {
    ...
    public Map<String, Object> list(PageUtil page) {
        ...
        try {
            List<Map<String, String>> modules = trainModuleService.queryUserRoleList(page);
    ...
    public Result add(CourseModule courseModule) {
        try {
            trainModuleService.insert(courseModule);
    ...
    public Result update(CourseModule courseModule) {
        try {
            trainModuleService.update(courseModule);
