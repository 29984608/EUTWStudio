        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="modules" lay-verify="required" lay-search="" id="showAreasAddInFloor">
    ...
    <form id="update-form" lay-filter="role-add" class="layui-form layui-form-pane" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="modules" id="showAreasUpdatesInFloor">
                            <option value="">直接选择或搜索选择</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="updateFloorNameInFloor" name="name"
                       placeholder="请输入楼层名称" autocomplete="off" class="layui-input ">
            </div>
        </div>
        <div class="layui-form-item">
