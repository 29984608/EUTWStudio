                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline">
                                <select name="modules" lay-verify="required" lay-search="">
                                    ...
                                    <option value="2">建设工程管理</option>
                                    <option value="3">物业管理</option>
                                    <option value="4">房地产管理</option>
                                    <option value="5">物业管理</option>
                                    <option value="6">建设工程管理</option>
                                    <option value="7">房地产管理</option>
                                    <option value="8">物业管理</option>
                                    <option value="9">物业管理</option>
                                    <option value="10">物业管理</option>
                                </select>
                            </div>
