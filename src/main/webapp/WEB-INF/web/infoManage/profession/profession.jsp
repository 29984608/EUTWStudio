        ...
        <form class="layui-form"   action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input name="password" required lay-verify="required" placeholder="专业代码" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="modules" lay-verify="required" lay-search="">
                        ...
                        <option value="1">物流贸易</option>
                        <option value="1">工程造价</option>
                        <option value="2">物流贸易</option>
                        <option value="3">物流贸易</option>
                        <option value="4">物流贸易</option>
                        <option value="5">物流贸易</option>
                        <option value="7">物流贸易</option>
                        <option value="8">物流贸易</option>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
