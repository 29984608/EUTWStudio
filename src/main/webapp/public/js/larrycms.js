var navtab;
layui.config({
    base: '../public/js/lib/' //layui自定义layui组件目录
}).extend({
    larry: 'larry',
    navtab: 'navtab',
    elemnts: 'elements',
    ...
    $(document).ready(function () {
        ...
        $menu.find('li.layui-nav-item').each(function () {
            ...
            $that.on('click', function () {
                ...
                }, {"pid": "105", "title": "友链管理", "icon": "larry-a157", "href": "html/temp.html"}];
                var pid_35 = [{
                    "title": "网站管理",
                    ...
                    "children": [{
                        ...
                        "href": "html/temp.html"
                    }, {"title": "附件数据管理", "icon": "larry-fujian", "href": "html/temp.html"}, {
                        "title": "文件管理器",
                    ...
                    "children": [{
                        ...
                        "href": "html/temp.html"
                    }, {"title": "临时内容管理", "icon": "larry-linshi1", "href": "html/temp.html"}, {
                        "title": "导入采集规则",
                        "icon": "larry-guize",
                        "href": "html/temp.html"
                    }, {"title": "监控采集模式", "icon": "larry-jiankong1", "href": "html/temp.html"}, {
                        "title": "采集未下载内容",
                        "icon": "larry-xiazai2",
                        "href": "html/temp.html"
                    }]
                    ...
                    "children": [{
                        ...
                        "href": "html/temp.html"
                    }, {"title": "网盟广告", "icon": "larry-guanggaolianmeng", "href": "html/temp.html"}]
                }, {
                    "title": "批量维护",
                    "icon": "larry-piliang",
                    "spread": "true",
                    "children": [{
                        ...
                        "href": "html/temp.html"
                    }, {"title": "更新栏目HTML", "icon": "larry-lanmu1", "href": "html/temp.html"}, {
                        "title": "更新文档HTML",
                        "icon": "larry-wendang",
                        "href": "html/temp.html"
                    }, {"title": "更新网站地图", "icon": "larry-wangzhanditu", "href": "html/temp.html"}, {
                        "title": "重复文档检测",
                        "icon": "larry-zhongfu",
                        "href": "html/temp.html"
                    }, {"title": "数据库内容替换", "icon": "larry-tihuan1", "href": "html/temp.html"}, {
                        "title": "自动摘要",
                        "icon": "larry-zhaiyao",
                        "href": "html/temp.html"
                    }, {"title": "搜索关键词维护", "icon": "larry-guanjianci", "href": "html/temp.html"}]
                }]
                var pid_40 = [{
                    "title": "微信配置",
